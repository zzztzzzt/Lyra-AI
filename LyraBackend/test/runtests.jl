...
# !!! Main.UserApp is configured as an alias for Main.LyraBackend and you might encounter it in some tests
using Main.LyraBackend, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "LyraBackend tests" begin
  @includetests ARGS
end
